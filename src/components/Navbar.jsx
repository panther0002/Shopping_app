...
const Navbar = () => {
  ...
  return (
      ...
      <nav className="flex flex-row justify-between items-center h-20  max-w-6xl mx-auto">
        ...
        <div className="flex gap-10 justify-center items-center font-medium text-slate-100 mr-5">
          ...
          <NavLink to="/cart">
            <div className="relative">
              <FaShoppingCart className="text-2xl"/>
                {
                  cart.length > 0 &&
                  <span className="absolute -top-1 -righr-2 bg-green-600 text-xs w-5 h-5 
