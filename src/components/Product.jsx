...
const Product = ({post}) => {
  ...
  return (
    ...
    gap-3 p-4 mt-10 ml-5 rounded-xl outline">
      ...
      <div className="flex justify-between gap-12 items-centerw-full mt-5">
        ...
        <div>
          {
            ...
            (
              <button onClick={addToCart} className="text-gray-700 border-2 border-gray-700 rounded-full font-semibold text-[12px] 
              p-1 px-3 uppercase hover:bg-gray-700 hover:text-white transition duration-300 ease-in">
                Add to cart
              </button>
            )
